...
// memoize
//  Memoize lets us take a functcion that takes a lot of time to run.  And memeorize
...
// }
// let N = 1000;
// console.time('slowFibonnaci:' + N)
// console.log('slowFib:',slowFibonnaci(N));
// console.timeEnd('slowFibonnaci:' + N);

// // define memoized fib function
// let fastFibonnaci = _.memoize(n => {
//   return n < 2 ? n: fastFibonnaci(n - 1) + fastFibonnaci(n - 2);
// });


// console.time('fastFibonnaci:' + N)
// console.log('first run of fastFib:',fastFibonnaci(N));
// console.timeEnd('fastFibonnaci:' + N);

// console.time('fastFibonnaci:' + N)
// console.log('second run of fastFib:',fastFibonnaci(N));
// console.timeEnd('fastFibonnaci:' + N);
...
// let fastFibonnaci = _.memoize(slowFibonnaci(50));

// let fastFibonnaci = (n) => {
//   return n < 2 ? n: _.memoize(slowFibonnaci(n - 1)) + _.memoize(slowFibonnaci(n - 2));  
// }; 
